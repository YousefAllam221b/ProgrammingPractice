...
def PuttingValues():
    ...
    flag4=False
    flag5=False
    length=[len(removeHolidayS(math)),len(removeHolidayS(physics)),len(removeHolidayS(cs)),len(removeHolidayS(production)),len(removeHolidayS(elct))]
    dict={"math":removeHolidayS(math),"physics":removeHolidayS(physics),"cs":removeHolidayS(cs),"production":removeHolidayS(production),"elct":removeHolidayS(elct)}
...
print(PuttingValues())
wb.save(r'C:\Users\Yousef\Documents\Python\appending.xlsx')
